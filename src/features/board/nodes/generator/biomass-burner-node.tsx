...
export const BiomassBurnerNode = memo((props: NodeProps) => {
  const { id } = props;
  ...
  return (
    <Stack
      ...
      p={1}
    >
      <Typography>{t(tokens.build.biomassBurner)}</Typography>
      <Handle
        type="target"
...
BiomassBurnerNode.displayName = 'biomass-burner-node';
